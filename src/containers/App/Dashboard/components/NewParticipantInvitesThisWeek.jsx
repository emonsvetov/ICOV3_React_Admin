...
const NewParticipantInvitesThisWeek = () => (
  <Col md={12} xl={3} lg={6} xs={12}>
    <Card>
      <CardBody className="dashboard__booking-card">
        ...
        <h5 className="dashboard__booking-total-description">New Participant Invites</h5>
...
export default NewParticipantInvitesThisWeek;
