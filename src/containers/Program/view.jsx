      ...
      <Row>
        <Col md={6}>
          ...
          <h3 className="page-subhead subhead">
            ...
            /{" "}
            <Link className="" to="/program">
              Programs
            </Link>{" "}
            / {program.name}{" "}
            {!!program.is_demo && (
              <span style={{ color: "red" }}>Demo Mode</span>
            )}
          </h3>
          <p>
            {" "}
          ...
          {showLiveMode && (
            <>
              ...
              <span
                ...
                onClick={() => toggle("activateLiveMode")}
              >
                Live Mode
              </span>
            </>
        ...
        <Col md="4" lg="4" xl="4">
          <Card>
            <CardBody>
              <Row
                onClick={() => {
                  history.push(`/program/${id}/subprograms`);
                }}
              >
                <Col md={3} className="col-left">
                  <img
            ...
            <CardBody>
              ...
              >
                ...
                <Col md={9} className="col-right pl-0">
                  <h5>Merchants</h5>
                  <p>
                    Select the merchants you want make available to your users.
                  </p>
                </Col>
              </Row>
            </CardBody>
              ...
              >
                <Col md={3} className="col-left">
                  <img
                    src={InvoiceIcon}
                    className="card-img-top"
                    alt="Invoice and Statement"
                  />
                </Col>
                <Col md={9} className="col-right pl-0">
                  <h5>Account</h5>
                  <p>
                    Create Invoices, View statements, Track funds and payments.
                  </p>
                </Col>
              </Row>
            </CardBody>
            ...
            <CardBody>
              ...
              >
                ...
                <Col md={9} className="col-right pl-0">
                  <h5>Digital Media</h5>
                  <p>
                    Upload brochures, newsletters, videos and more for users to
                    view.
                  </p>
                </Col>
              </Row>
