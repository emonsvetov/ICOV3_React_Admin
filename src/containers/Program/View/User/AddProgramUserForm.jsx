...
const AddProgramUserForm = ({organization, program, toggle, setTrigger}) => {
    ...
    return (
        <form className="form" onSubmit={handleSubmit}>
            ...
            <ProgramUserFormFields config={config} form={form} submitting={submitting} pristine={pristine} values={values} unitNumberOptions={unitNumberOptions} program={program}/>
        </form>
    )}}
    </Form>
)}
