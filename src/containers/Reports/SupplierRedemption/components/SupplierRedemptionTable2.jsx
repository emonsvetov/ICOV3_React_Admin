...
const SupplierRedemptionTable2: FC<SupplierRedemptionTableProps> = ({dataReport}) => {
            ...
            summary={() => (
                <Table.Summary fixed>
                    <Table.Summary.Row>
                        ...
                        {columns.map(item => (
                            item.footer !== 'Total' && (<Table.Summary.Cell index={item.key}>{item.footer}</Table.Summary.Cell>)
                        ))}
                    </Table.Summary.Row>
                </Table.Summary>
            )}
...
export default SupplierRedemptionTable2;
